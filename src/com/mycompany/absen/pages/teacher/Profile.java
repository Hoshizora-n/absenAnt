...
public class Profile extends javax.swing.JDialog {
    ...
    private void getData() {
        ...
        try (Connection connection = koneksi.getConnection()) {
            // First query
            String query = "select * from teachers t where user_id = ? LIMIT 1";
    ...
    private void initComponents() {
        ...
        jLabel8.setText("note: newPassword is not mandatory, fill when update password");
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        ...
        if (name.equals("")) {
            ...
            try (Connection conn = koneksi.getConnection()) {
                String query = "UPDATE teachers SET name=?, number=? where id=?";
